      ...
      <form
        onSubmit={async (e) => {
          ...
          try {
            ...
            if (res.ok) {
              // The server set an httpOnly session cookie; re-render the
              // (server-component) page so it reads the cookie and swaps in
              // the app. No client-readable auth flag to set — that's the point.
              router.refresh();
            } else {
